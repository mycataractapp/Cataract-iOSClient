...
class ContactsInputOverviewController : DynamicController, UIListViewDataSource, UIListViewDelegate
{
    ...
    var contactsInputControllerSize : CGSize
    {
        get
        {
            ...
            contactsInputControllerSize.height = canvas.draw(tiles: 5)
