...
class AppointmentFormDetailController : DynamicController, DynamicViewModelDelegate, UIPageViewDelegate, UIPageViewDataSource
{
    ...
    var datePickerControllerSize : CGSize
    {
        get
        {
            ...
            datePickerControllerSize.width = self.dateContainerView.frame.size.width - canvas.draw(tiles: 1)
            datePickerControllerSize.height = canvas.draw(tiles: 10)
    ...
    var timePickerControllerSize : CGSize
    {
        get
        {
            ...
            timePickerControllerSize.width = self.dateContainerView.frame.size.width - canvas.draw(tiles: 1)
            timePickerControllerSize.height = canvas.draw(tiles: 10)
    ...
    override func render(canvas: DynamicCanvas) -> DynamicCanvas
    {
        ...
        self.appointmentLabel.frame.size.height = canvas.draw(tiles: 3)
        
        self.button.frame.size.width = canvas.draw(tiles: 3)
        ...
        self.button.frame.origin.x = self.pageView.frame.size.width - self.button.frame.size.width - canvas.draw(tiles: 0.5)
        self.button.frame.origin.y = self.appointmentInputOverviewController.view.frame.size.height - canvas.draw(tiles: 4)
        ...
        self.datePickerController.view.frame.origin.x = canvas.draw(tiles: 0.5)
        self.datePickerController.view.frame.origin.y = (self.dateContainerView.frame.size.height - self.datePickerController.view.frame.size.height - self.timePickerController.view.frame.size.height - canvas.draw(tiles: 1.5)) / 2
        
        self.timePickerController.view.frame.origin.x = self.datePickerController.view.frame.origin.x
        self.timePickerController.view.frame.origin.y = self.datePickerController.view.frame.origin.y + self.datePickerController.view.frame.size.height + canvas.draw(tiles: 0.5)
    ...
    override func bind()
    {
        ...
        self.appointmentInputOverviewController.bind()
        self.inputController.bind()
        self.datePickerController.bind()
        self.timePickerController.bind()
