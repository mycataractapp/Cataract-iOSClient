...
class AppDetailController : DynamicController, UIPageViewDelegate, UIPageViewDataSource, DynamicViewModelDelegate, UNUserNotificationCenterDelegate
{
...
//                print("AA", self._appointmentStore)
    ...
    var navigationOverviewControllerSize : CGSize
    {
        get
        {
            ...
            navigationOverviewControllerSize.height = canvas.draw(tiles: 4)
    ...
    var menuOverviewSize : CGSize
    {
        get
        {
            ...
            menuOverviewSize.height = canvas.draw(tiles: 9)
    ...
    override func viewDidLoad()
    {
        ...
        self.dropOverviewController.dropStore.load(count: 20, content: nil, isNetworkEnabled: false)
    }
    ...
    override func render(canvas: DynamicCanvas) -> DynamicCanvas
    {
        ...
        self.dropButton.frame.size.width = canvas.draw(tiles: 3)
        self.dropButton.frame.size.height = self.dropButton.frame.size.width
        
        self.appointmentButton.frame.size.width = canvas.draw(tiles: 3)
        self.appointmentButton.frame.size.height = self.appointmentButton.frame.size.width
        
        self.contactsButton.frame.size.width = canvas.draw(tiles: 3)
        self.contactsButton.frame.size.height = self.contactsButton.frame.size.width
        
        self.navigationOverviewController.view.frame.origin.y = canvas.size.height - self.navigationOverviewController.view.frame.size.height
        ...
        self.dropButton.frame.origin.x = self.dropOverviewController.view.frame.size.width - canvas.draw(tiles: 4.5)
        ...
        self.appointmentButton.frame.origin.x = self.appointmentTimeOverviewController.view.frame.size.width - canvas.draw(tiles: 4.5)
        ...
        self.contactsButton.frame.origin.x = self.contactsOverviewController.view.frame.size.width - canvas.draw(tiles: 4.5)
    ...
    override func bind()
    {
        ...
        self.menuOverviewController.bind()
        self.dropOverviewController.bind()
        self.appointmentTimeOverviewController.bind()
        self.navigationOverviewController.bind()
        self.faqOverviewController.bind()
...
//                    print("???", appointmentModel.timeModel.identifier)
    ...
    func enterDropForm()
    {
        ...
        self.dropFormDetailController!.bind()
        self.dropFormDetailController!.viewModel.addObserver(self,
                                                             forKeyPath: "event",
                                                             options: NSKeyValueObservingOptions([NSKeyValueObservingOptions.new,
                                                                                                  NSKeyValueObservingOptions.initial]),
                                                             context: nil)
        self.dropFormDetailController!.dropFormInputController.colorStore.load(count: 7, content: nil, isNetworkEnabled: false)
    ...
    func enterAppointmentForm()
    {
        ...
        self.appointmentFormDetailController!.bind()
    ...
    func enterContactsForm()
    {
        ...
        self.contactsFormDetailController!.bind()
