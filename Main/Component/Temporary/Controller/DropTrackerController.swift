...
class DropTrackerController : DynamicController
{
    ...
    override func render(canvas: DynamicCanvas) -> DynamicCanvas
    {
        ...
        self.emptyDropTrackerImageView.frame.size.width = canvas.draw(tiles: 3)
        self.emptyDropTrackerImageView.frame.size.height = self.emptyDropTrackerImageView.frame.size.width
        
        self.filledDropTrackerImageView.frame.size.width = canvas.draw(tiles: 3)
        self.filledDropTrackerImageView.frame.size.height = self.filledDropTrackerImageView.frame.size.width
        
        self.scaleView.frame.size.width = canvas.size.width - self.emptyDropTrackerImageView.frame.size.width -  self.filledDropTrackerImageView.frame.size.width - canvas.draw(tiles: 1.5)
         self.scaleView.frame.size.height = 1
        
        self.runningImageView.frame.size.width = canvas.draw(tiles: 2)
        self.runningImageView.frame.size.height = self.runningImageView.frame.size.width
        
        self.timeLabel.frame.size.width = canvas.size.width - canvas.draw(tiles: 1)
        self.timeLabel.frame.size.height = canvas.draw(tiles: 3)
        
        self.emptyDropTrackerImageView.frame.origin.x = canvas.draw(tiles: 0.5)
        self.emptyDropTrackerImageView.frame.origin.y = (canvas.size.height - self.emptyDropTrackerImageView.frame.size.height - self.timeLabel.frame.size.height - canvas.draw(tiles: 2)) / 2
        
        self.filledDropTrackerImageView.frame.origin.x = canvas.size.width - canvas.draw(tiles: 3.5)
        self.filledDropTrackerImageView.frame.origin.y = self.emptyDropTrackerImageView.frame.origin.y
        
        self.scaleView.frame.origin.x = self.emptyDropTrackerImageView.frame.origin.x + self.emptyDropTrackerImageView.frame.size.width + canvas.draw(tiles: 0.25)
        ...
        self.timeLabel.frame.origin.y = self.emptyDropTrackerImageView.frame.origin.y + self.emptyDropTrackerImageView.frame.size.height + canvas.draw(tiles: 2)
