//
//  UIListViewHeaderFooterContentView.swift
//  Pacific
//
...
class UIListViewHeaderFooterContentView : UIView
{
    ...
    override func layoutSubviews()
    {
        ...
        {
            self.label.frame.origin.y = self.frame.height - self.label.frame.height - 5
        }
